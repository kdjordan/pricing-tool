...
<script setup lang="ts">
	import { ref } from 'vue';
	import { type ComparisonReport, USColumnRole, DBName } from '../../types/app-types';
	...
	const columnRoleOptions: { value: USColumnRole; label: string; }[] = [
		{ value: USColumnRole.NPA, label: 'NPA' },
		{ value: USColumnRole.NXX, label: 'NXX' },
		{ value: USColumnRole.Rate, label: 'Rate' },
	];
