	...
	<div class="bg-background rounded-lg h-full p-8">
		...
		<div v-if="report" class="space-y-10">
			...
			<div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
				<h2
					class="py-4 text-2xl font-semibold text-center text-foreground bg-gradient-to-r from-gray-800 to-accent px-6"
				>
					<span class="text-background">
						<span class="text-mutedForeground">{{
							report.fileName1
						}}</span>
						SHOULD BUY THESE DESTINATIONS FROM
						<span class="text-muted">{{ report.fileName2 }}</span>
					</span>
				</h2>
					...
					<table class="w-full">
						<thead>
							<tr class="border-b border-gray-700">
								<th
									class="py-3 text-left text-gray-400 px-4 max-w-[250px] w-[250px]"
								>
									Dial Code(s)
								</th>
								<th class="py-3 text-left text-gray-400 px-4">
									Destination
								</th>
								<th class="py-3 text-right text-gray-400 px-4">
									Rate - {{ report.fileName1 }}
								</th>
								<th class="py-3 text-right text-gray-400 px-4">
									Rate - {{ report.fileName2 }}
								</th>
								<th class="py-3 text-right text-gray-400 px-4">
									Difference (%)
								</th>
						...
						<tbody>
							...
							>
								<td
									class="py-3 text-foreground px-4 max-w-[250px] w-[250px]"
								>
			...
			<div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
				<div
					class="py-4 px-6 bg-gradient-to-r from-gray-800 to-accent flex justify-between items-center"
				>
					<div class="w-1/4"></div>
					<h2
						class="text-2xl font-semibold text-center text-background flex-grow"
					>
						Unmatched Codes
					</h2>
